...
namespace Luminary::Routine::SineWave
{
  ...
  Public Data
  -------------------------------------------------------------------------------*/
  AnimationCB sineWaveAnimation2;

  /*-------------------------------------------------------------------------------
  Static Data & Literals
  -------------------------------------------------------------------------------*/
  static constexpr size_t updateRate = 83;
  ...
  void construct2()
  {
    sineWaveAnimation2.destroy    = destroy;
    sineWaveAnimation2.initialize = initialize;
    sineWaveAnimation2.lastTime   = Chimera::millis();
    sineWaveAnimation2.startTime  = Chimera::millis();
    sineWaveAnimation2.step       = 0;
    sineWaveAnimation2.stopTime   = std::numeric_limits<size_t>::max();
    sineWaveAnimation2.update     = update;
    sineWaveAnimation2.updateDT   = updateRate;
  }
