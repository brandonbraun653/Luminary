...
c:\SysGCC\arm-eabi\bin\arm-none-eabi-g++.exe @"VisualGDB/Debug/animation_breath.gcc.rsp" || exit 1
...
c:\SysGCC\arm-eabi\bin\arm-none-eabi-g++.exe @"VisualGDB/Debug/animation_twinkle.gcc.rsp" || exit 1
echo processor.cpp
